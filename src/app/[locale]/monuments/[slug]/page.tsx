...
export default async function MonumentsInnerPage() {
  return (
    <>
      <GalleryHero />
          ...
          <div className="w-11/12 mx-auto px-4 sm:px-8">
            <div className="max-w-full md:max-w-[66.66667%] mx-auto">
              ...
              <ul className="my-5 ps-2">
                <li className="text-sm leading-7 m-0 before:inline-block before:w-1.5 before:h-1.5 before:bg-primary-dark before:rounded-full before:me-2.5 before:mb-1 before:align-middle">
              ...
              <blockquote className="my-5 flex rounded-lg bg-primary-light px-8 py-8">
                <div className="me-5">
                  <svg
                    width="37"
                    height="25"
