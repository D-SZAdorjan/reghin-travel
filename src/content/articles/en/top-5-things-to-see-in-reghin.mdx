...
<div className="p-0 w-fit border-2 border-solid border-primary rounded-lg bg-primary-light">
    <div className="grid grid-cols-3 w-fit p-0">
        <InfoIconOpenHours
            title="Opening Hours"
            openHours="The museum is open on weekdays from 8 AM to 6 PM."
        />
        <InfoIconAddress
            className="border-t-2 md:border-t-0 border-solid border-primary"
            title="Address"
